FHV01 <- read.csv("fhv_tripdata_2015-01.csv")
...
FHV02 <- read.csv("fhv_tripdata_2015-02.csv")
...
FHV03 <- read.csv("fhv_tripdata_2015-03.csv")
...
FHV04 <- read.csv("fhv_tripdata_2015-04.csv")
...
FHV05 <- read.csv("fhv_tripdata_2015-05.csv")
...
FHV06 <- read.csv("fhv_tripdata_2015-06.csv")
...
FHV07 <- read.csv("fhv_tripdata_2015-07.csv")
...
FHV08 <- read.csv("fhv_tripdata_2015-08.csv")
...
FHV09 <- read.csv("fhv_tripdata_2015-09.csv")
...
FHV10 <- read.csv("fhv_tripdata_2015-10.csv")
...
FHV11 <- read.csv("fhv_tripdata_2015-11.csv")
...
FHV12 <- read.csv("fhv_tripdata_2015-12.csv")
...
Total_FHV15 <- rbind(FHV01,FHV02,FHV03,FHV04,FHV05,FHV06,FHV07,FHV08,FHV09,FHV10,FHV11,FHV12)
rm(FHV01,FHV02,FHV03,FHV04,FHV05,FHV06,FHV07,FHV08,FHV09,FHV10,FHV11,FHV12)

##set up##
#floor time by hour
#library(lubridate) 
x = as.POSIXct(Total_FHV15$Pickup_date)
Total_FHV15$POroundtime <- floor_date(x, "60 minutes")
Total_FHV15$POroundtime <- format(as.POSIXct(strptime(Total_FHV15$POroundtime,"%Y-%m-%d %H:%M:%S", tz="")), format = "%H:%M:%S")

#weekdays
#library(lubridate)
Total_FHV15$day_of_week<-wday(Total_FHV15$Pickup_date)

#filter by TOD and DOW
Total_FHV15 <- Total_FHV15[Total_FHV15$day_of_week %in% c(2,3,4,5,6) & (Total_FHV15$POroundtime %in% c("07:00:00","08:00:00","17:00:00","18:00:00","19:00:00")),]

#subset by taxi zone
Old_Astoria15 <- subset(Total_FHV15, locationID == 179)
Astoria15 <-subset(Total_FHV15, locationID == 7)
Greenpoint15 <-subset(Total_FHV15, locationID == 112)
Williamsburg15 <-subset(Total_FHV15, locationID == 255)
Red_Hook15 <-subset(Total_FHV15, locationID == 195)
Carroll_Gardens15 <-subset(Total_FHV15, locationID == 40)
Gowanus15 <-subset(Total_FHV15, locationID == 106)

#export CSVs
write.csv(Old_Astoria15, "Old Astoria 2015.csv")
write.csv(Astoria15, "Astoria 2015.csv")
write.csv(Greenpoint15, "Greenpoint 2015.csv")
write.csv(Williamsburg15, "Williamsburg 2015.csv")
write.csv(Red_Hook15, "Red Hook 2015.csv")
write.csv(Carroll_Gardens15, "Carroll Gardens 2015.csv")
write.csv(Gowanus15, "Gowanus 2015.csv")
write.csv(Total_FHV15, "Total FHV Trips 2015.csv")
